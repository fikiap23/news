                                ...
                                <div class="image-picker ">
                                    @php
                                        $style =
                                            ...
                                            ($setting['logo']
                                                ? asset($setting['logo'])
                                                : asset('assets/image/logo_dpmtsp.png')) .
                                            ')"';
                                    @endphp
                                                ...
                                                <td class="p-2">
                                                    <div class="form-check form-check-custom">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="{{ $key }}" name="payment_gateway[]"
                                                            id="{{ $key }}"
                                                            {{ in_array($paymentGateway, $selectedPaymentGateways) ? 'checked' : '' }} />
    ...
    <div class="container-fluid mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        {{ Form::label('show_captcha', __('Show Captcha On Registration') . ':', ['class' => 'form-label fs-6']) }}
                    </div>
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active" name="show_captcha_on_registration"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active" name="show_captcha" id="showCaptcha"
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active" name="whatsapp" id="whatsapp"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active" name="linkedin" id="linkedin"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active" name="twitter" id="twitter"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active" name="facebook" id="facebook"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active" name="reddit" id="reddit"
