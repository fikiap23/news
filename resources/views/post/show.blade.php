            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6 mt-3">
                        ...
                        <span
                            class="badge bg-{{ $post->visibility == \App\Models\Post::VISIBILITY_ACTIVE ? 'primary' : 'danger' }}  fs-7 m-1 ">
                    ...
                    <div class="col-6 mt-3">
                        ...
                        <span
                            class="badge bg-{{ $post->status == \App\Models\Post::STATUS_ACTIVE ? 'success' : 'danger' }}  fs-7 m-1 ">
                    ...
                    <div class="col-6 mt-3">
                        ...
                        <span
                            class="badge bg-{{ $post->featured == \App\Models\Post::VISIBILITY_ACTIVE ? 'primary' : 'danger' }}  fs-7 m-1 ">
                    ...
                    <div class="col-6 mt-3">
                        ...
                        <span
                            class="badge bg-{{ $post->breaking == \App\Models\Post::VISIBILITY_ACTIVE ? 'primary' : 'danger' }}  fs-7 m-1 ">
                    ...
                    <div class="col-6 mt-3">
                        ...
                        <span
                            class="badge bg-{{ $post->slider == \App\Models\Post::VISIBILITY_ACTIVE ? 'primary' : 'danger' }}  fs-7 m-1 ">
                    ...
                    <div class="col-6 mt-3">
                        ...
                        <span
                            class="badge bg-{{ $post->recommended == \App\Models\Post::VISIBILITY_ACTIVE ? 'primary' : 'danger' }}  fs-7 m-1 ">
                    ...
                    <div class="col-6 mt-3">
                        ...
                        <span
                            class="badge bg-{{ $post->show_registered_user == \App\Models\Post::VISIBILITY_ACTIVE ? 'primary' : 'danger' }}  fs-7 m-1 ">
                    ...
                    <div class="col-6 mt-3">
                        ...
                        <p>{{ !empty($post->scheduled_post_time) ? Carbon\Carbon::parse($post->scheduled_post_time)->format('Y-m-d') : __('messages.menu.n_a') }}
                        </p>
                    </div>
                    <div class="col-6 mt-3">
                        <h5>{{ __('messages.delete') . ' ' . __('messages.post.scheduled_post') }}</h5>
                        <p>{{ !empty($post->scheduled_post_time) ? Carbon\Carbon::parse($post->scheduled_delete_post_time)->format('Y-m-d') : __('messages.menu.n_a') }}
                        </p>
                    </div>
                    <div class="col-6 mt-3">
                                            ...
                                            <div class="emoji">
                                                <div>
                                                    <div class="d-block position-relative text-center float-left">
                                                        ...
                                                        <label class="post-reaction-count  like-reaction"
                                                            id="{{ $emoji->id }}">
                                                            {{ isset($countEmoji[$emoji->id]) ? count($countEmoji[$emoji->id]) : 0 }}
                                                        </label>
                                                        <p class="fs-12 mb-0">{{ __('messages.reaction.' . $emoji->name) }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
