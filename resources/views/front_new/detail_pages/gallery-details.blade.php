                            ...
                            <div class="news-details">
                                ...
                                <div class="news-desc mb-20 position-relative mt-4">
                                    @if (!empty($galleryPost))
                                        <h3 class="text-black fw-7 fs-20">
                                            {{ $galleryPostNo }}.{{ $galleryPost->gallery_title }}</h3>
                                        <figure class="mb-2 gallery-list-image">
                                            ...
                                            <img src="{{ $galleryPost->post_gallery_image }}" alt=""
                                                class="position-relative">
                                            <figcaption>
                                                <i><small>{!! $galleryPost->image_description !!}</small></i>
                                            </figcaption>
                                        </figure>
                                        <div class="post-body">
                                            <p>
                                        ...
                                        <div class="gallery-post-buttons d-flex justify-content-between">
                                            <div>
                                                ...
                                                <a href="{{ route('detailPage.gallery', ['data' => $postDetail->slug, 'id' => $galleryPostNo - 1]) }}"
                                                    ...
                                                    {{ $inStyle }}="{{ $style }}"
                                                    {{ $galleryPost->id == $firstGalleryPost->id ? 'hidden' : '' }}>
                                                    < Previous </a>
                                            </div>
                                            <div>
                                                <a href="{{ route('detailPage.gallery', ['data' => $postDetail->slug, 'id' => $galleryPostNo + 1]) }}"
                                                    ...
                                                    {{ $inStyle }}="{{ $style }}"
                                                    {{ $galleryPost->id == $lastGalleryPost->id ? 'hidden' : '' }}>
                                                    Next >
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card d-flex flex-row mb-40">
                                                    ...
                                                    <div class="col-8 card-body ms-4 ">
                                                        ...
                                                        <span class="fs-14 text-gray">
                                                            {{ $previousPost['created_at']->format('M d, Y') }}</span>
                                                    </div>
                                            ...
                                            @if (!empty($nextPost))
                                                <div class="card d-flex flex-row mb-40">
                                                    ...
                                                    <div class="col-8 ms-4 ">
                                                        ...
                                                        <span
                                                            class=" fs-14 text-gray">{{ $nextPost['created_at']->format('M d, Y') }}</span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 mb-2">
                                                    <div class="card position-relative slide-item">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <span
                                                                class="card-text fs-12 text-gray">{{ $relatedPost['created_at']->format('M d, Y') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                @if ($loop->iteration >= 6)
                                    ...
                                    @if (!Auth::check())
                                        ...
                                        <div class="col-md-6">
                                            <input type="email" name="email" id="email"
                                                class="form-control fs-14 text-gray" placeholder="Enter Your Email"
                                                required>
                                        </div>
                                    @endif
                                    <div class="col-12">
