                        ...
                        <section class="news-details-left pe-xxl-3">
                            <div class="news-details">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="d-flex justify-content-start flex-column">
                                                <a
                                                    ...
                                                    <span
                                                        class="fs-12 text-gray">{{ ucfirst(__('messages.common.' . strtolower($postDetail->created_at->format('F')))) }}
                                    ...
                                    <div class="col-sm-4">
                                        <div class="news-text mb-2">
                                            <div class="desc d-inline-block">
                                                ...
                                                <span
                                                    class="fs-14 text-gray me-1">{{ $comments->count() ? $comments->count() : 0 }}</span>
                                            </div>
                                            <div class="desc d-inline-block">
                                                <i class="fa-solid fa-clock fs-12 text-gray me-1"></i>
                                                <span class="fs-14 text-gray me-1">
                                                    {{ getReadingTime($postDetail->sort_list_content) }}</span>
                                            </div>
                                            <div class="desc d-inline-block">
                                ...
                                <div class="news-content-img position-relative">
                                    <div class="news-details-img rounded-10"><a href="#"><img
                                                src="{{ $postDetail->post_image }}" class="w-100 h-100"></a>
                                    </div>
                                                ...
                                                <div class="swiper addition-image-swiper">
                                                    <div class="swiper-wrapper justify-content-center">
                                                        @foreach ($postDetail->additional_image as $image)
                                                            <div class="swiper-slide mx-2"> <img src="{{ $image }}"
                                                                    alt="" class="w-100" height="400"></div>
                                                        @endforeach
                                                    </div>
                                                ...
                                                <div class="card d-flex flex-row mb-40">
                                                    ...
                                                    <div class="col-8 card-body ms-4">
                                                        ...
                                                        <span class="fs-14 text-gray">
                                                            {{ ucfirst(__('messages.common.' . strtolower($previousPost['created_at']->format('M')))) }}
                                                            {{ $previousPost['created_at']->format('d, Y') }}</span>
                                                    </div>
                                            ...
                                            @if (!empty($nextPost))
                                                <div class="card d-flex flex-row mb-40">
                                                    ...
                                                    <div class="col-8 ms-4 ">
                                                        ...
                                                        <span
                                                            class=" fs-14 text-gray">{{ ucfirst(__('messages.common.' . strtolower($nextPost['created_at']->format('M')))) }}
                                                            {{ $nextPost['created_at']->format('d, Y') }}</span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 mb-2">
                                                    <div class="card position-relative slide-item">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <span
                                                                class="card-text fs-12 text-gray">{{ ucfirst(__('messages.common.' . strtolower($relatedPost['created_at']->format('M')))) }}
