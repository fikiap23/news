<div class="aside-menu-container" id="sidebar">
    <div class="aside-menu-container__aside-logo flex-column-auto">
        <a href="{{ url('/') }}" data-turbo="false"
            class="text-decoration-none sidebar-logo d-flex align-items-center" target="_blank"
            title="{{ strlen(getAppName()) > 12 ? substr(getAppName(), 0, 12) . '...' : getAppName() }}">
            <div>
                <img src="{{ $settings['logo'] }}" class="img-fluid" width="60px" height="50px">
            </div>
        </a>
